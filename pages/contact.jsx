      ...
      <div className=" px-4 py-2">
        ...
        <div className="h-16 w-full card_stylings text-xl sm:text-3xl flex gap-x-8 sm:gap-x-16 items-center justify-center text-Snow">
          <a
            ...
            href="https://github.com/sophe4rum"
            target="_blank"
            rel="noreferrer"
          >
            <FaGithub />
          ...
          <a
            className="hover:scale-125 ease-in-out duration-700"
            href="https://www.linkedin.com/in/sorn-sophearum-6a5755271/"
            target="_blank"
            rel="noreferrer"
          >
            <FaLinkedin />
          ...
          <a
            className="hover:scale-125 ease-in-out duration-700"
            href="https://twitter.com/rum_sorn"
            target="_blank"
            rel="noreferrer"
          >
            <FaTwitter />
          ...
          <a
            className="hover:scale-125 ease-in-out duration-700"
            href="https://www.facebook.com/sophearum.sorn"
            target="_blank"
            rel="noreferrer"
          >
            <FaFacebook />
      ...
      >
        <div className="flex flex-col items-center justify-center">
          ...
          <a
            ...
            target="_blank"
            href="https://t.me/sophearum10" rel="noreferrer"
          >
           👉 Contact My Telegram 👈
          </a>
        </div>
